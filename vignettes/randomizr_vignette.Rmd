...
With `balanced_ra` however we see that every draw treats three units overall and one or two in each block. Declare the design with `declare_ra(..., ra_type = "balanced")`. The [introduction article](https://declaredesign.org/r/randomizr/articles/balanced_ra.html) has the details.
