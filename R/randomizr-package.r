...
#'   \item [balanced_ra()] (experimental) holds condition counts (and, with
#'     \code{formula}, covariate totals) at their targets while keeping
#'     each unit's probability exact.
