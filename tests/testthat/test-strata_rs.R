...
expect_error(strata_rs(strata_var=strata_var, strata_m = c(10, 101, 40)))
...
S <- strata_rs(strata_var=strata_var, strata_m = c(20, 30, 40))
table(strata_var, S)
probs <- strata_rs_probabilities(strata_var = strata_var, strata_m = c(20, 30, 40))
table(strata_var,probs)
